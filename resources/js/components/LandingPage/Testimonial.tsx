        ...
        <div className="container mx-auto px-6 py-12">
            ...
            <div className="relative overflow-hidden">
                <motion.div
                    className="flex"
                    animate={{
                        x: ['0%', `-${100 * testimonials.length / (testimonials.length + 1)}%`],
                    }}
                    transition={{
                ...
                >
                    {[...testimonials, ...testimonials].map((testimonial, index) => (
                        ...
                        >
                            <div className="bg-gray-50 p-8 rounded-xl h-full shadow-sm">
                                <div className="flex items-center mb-4">
                                    <div className="w-16 h-16 rounded-full overflow-hidden mr-4 border-2 border-white shadow">
                                        <img
