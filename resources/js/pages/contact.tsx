...
import { MapPin, Phone, Mail, Clock, School, Send, Github } from 'lucide-react';
...
export default function Contact({ flash }: MessageFlash) {
                                    ...
                                    <form className="space-y-6" onSubmit={handleSubmit}>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                />
                                                <InputError message={errors.prenom} className="mt-1 text-sm text-red-600" />
                                            ...
                                            <div>
                                                ...
                                                />
                                                <InputError message={errors.nom} className="mt-1 text-sm text-red-600" />
                                            </div>
